...
1. **Clone the repository**
    ```
    git clone https://github.com/DRV-Sai-Siddarth/Prime-Power.git
    cd Prime-Power
    ```
2. **Run the program**
    ```
    ...
    ```
    *If your main file has a different name, replace `prime_power.py` with its name.*
...
Enter a number: 20
20 is neither a prime nor a power.
...
Prime-Power/
├── prime_power.ipynb # Main Python script
